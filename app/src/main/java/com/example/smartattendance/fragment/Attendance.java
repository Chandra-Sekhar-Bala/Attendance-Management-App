...
public class Attendance extends Fragment {
    ...
    private static final String TAG = AddDbFragment.class.getSimpleName();
...
//                    Toast.makeText(getContext(), "Direction Bottom", Toast.LENGTH_SHORT).show();
        ...
        adapter = new CardStackAdapter(addList(),requireContext());
